...
scriptversion="0533"										#scriptversion
tsversion="3.0.13.6"                                        #version of teamspeak server
call_home="http://r4p3.6te.net"								#check for updates
serverdir="/home/$teamspeakuser/teamspeak3-server$version"	#Don't change this!
dl_x86="wget https://dl.dropboxusercontent.com/s/l57rzwhdpkzh1gy/teamspeak3-server_linux_x86.tar.gz?dl=0 -O crack.tar.gz"
dl_amd64="wget https://dl.dropboxusercontent.com/s/jhghf5f3qs8rtug/teamspeak3-server_linux_amd64.tar.gz?dl=0 -O crack.tar.gz"
